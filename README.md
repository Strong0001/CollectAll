...
## App Demo
https://github.com/user-attachments/assets/f366468f-ec7a-4794-8d62-cb46176b049b
...
* **Autonomous Data Sourcing & Asynchrones ML-Training:**<br> Die Beschaffung von Marktdaten verlässt sich bewusst nicht auf starre Drittanbieter-APIs. Stattdessen sucht ein autonomer KI-Agent über Web-Tools nach realen Preisen, exakt basierend auf den vom System vorgegebenen Merkmalen und Werten (z.B. Zustand, Edition).<br>
***Die architektonische Herausforderung:***<br> Um das Frontend niemals zu blockieren und Ausfallsicherheit zu garantieren, werden Suchaufträge zuerst sicher in PostgreSQL geschrieben und von dort in eine Azure Queue überführt. Diese Queue triggert dedizierte Azure App Jobs für den Agenten. Das Smartphone-Frontend wartet zu keinem Zeitpunkt auf diese Hintergrundprozesse. Die so gesammelten Preisdaten werden anschließend von einem völlig entkoppelten Azure ML Cluster-Job genutzt, der stündlich (im Batch-Verfahren) vollautomatisiert neue XGBoost-Modelle trainiert und dem System zur Verfügung stellt.
